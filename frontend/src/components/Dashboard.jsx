        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center space-x-3 sm:space-x-4 w-full sm:w-auto">
              ...
              />
              <div>
                <h1 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-white">Leads Dashboard</h1>
                <p className="mt-1 text-xs sm:text-sm text-blue-100">View and manage leads generated by your team</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-8">
        ...
        <div className="bg-gray-50 rounded-lg border border-gray-200 shadow-sm p-4 sm:p-6 mb-4 sm:mb-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="ml-2 text-base sm:text-lg font-semibold text-slate-900">Filters</h2>
          </div>
        ...
        <div className="bg-gray-50 rounded-lg border border-gray-200 shadow-sm overflow-hidden">
          <div className="px-4 sm:px-6 py-3 sm:py-4 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 border-b border-gray-200">
            <h2 className="text-base sm:text-lg font-semibold text-white">Leads Overview</h2>
          </div>
                  ...
                  filteredLeads
                    ...
                    .map((lead, index) => (
                      ...
                      >
                        ...
                        <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap hidden md:table-cell">
                          <div className="flex items-center">
                            <div className={`w-6 h-6 sm:w-8 sm:h-8 ${getEmployeeAvatarColor(lead.employeeName)} rounded-full flex items-center justify-center mr-2 sm:mr-3`}>
                        ...
                        <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                          <span className={`px-2 sm:px-3 py-1 text-xs font-medium rounded-md border ${getStatusColor(lead.status)}`}>
                            {lead.status}
                          </span>
                        </td>
                        <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap hidden lg:table-cell">
